...
async function withdrawBalance(utils, api, amount) {
    ...
    const data = { publicKey: pkey, currency: utils.currency, amount: new bignumber_js_1.default(amount).toString(), nonce: await utils.getNonce(), signature: undefined };
    ...
    const isValid3 = c.ownerToAddress(base64url_1.default.decode(data.publicKey)) === c.address;
